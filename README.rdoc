...
## Instruction:
1. git clone github.com/vgudzhev/ssrs
2. open command prompt and navigate to the cloned repo
3. type->
        activator cleanFiles
        activator run

-> The web app is ready;
** If you want to use MySQL, not H2base you must uncoment the following lines from root/conf/application.conf:
